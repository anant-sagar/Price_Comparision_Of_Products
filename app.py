...
with st.spinner("Welcome!!"):
    ...
    with col2:
        ...
        with col:
            ...
            st.markdown(
                '<marquee class="content" style = "float:right;"> Made By Prashant Shukla</marquee>', unsafe_allow_html=True)
...
#---------------------------------------Footer-----------------------------------------#
    ...
    st.markdown(
                '<marquee class="content" style = "float:right;"> Visit My gitHub:- https://github.com/anant-sagar</marquee>', unsafe_allow_html=True)
